...
| Edition 3.1 |     |  November 2000 |     |     | S-57 Appendix A |
| ----------- | --- | -------------- | --- | --- | --------------- |

|     | IHO Object Catalogue | I   |
| --- | -------------------- | --- |
CONTENTS
Introduction
...
| S-57 Appendix A  | November 2000 | Edition 3.1 |
| ---------------- | ------------- | ----------- |

| II  | IHO Object Catalogue |     |
| --- | -------------------- | --- |
Page intentionally left blank
| Edition 3.1 |  November 2000 | S-57 Appendix A |
| ----------- | -------------- | --------------- |

IHO Object Catalogue III
Introduction
...
object class, attributes and attribute values. For example, a red lateral buoy would be encoded as follows:-
feature object class: buoy lateral; attribute: colour; attribute value: red.
The data model defines four types of feature object:
Geo containing the descriptive characteristics of a real world entity.
Meta containing information about other objects (eg. compilation scale, vertical datum).
Collection containing information about the relationships between other objects.
...
| ------------ | --------- | --------- | ------ | ------------- |
before making use of this document.
| Edition 3.1 |     | November 2000 |     | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --- | --------------------------- |
...
| S-57 Appendix A - Chapter 1       | November 2000 |        |     | Edition 3.1 |
...
subsets:
* subset >Attribute_A=: Attributes in this subset define the individual characteristics of an object;
* subset >Attribute_B=: Attributes in this subset provide information relevant to the use of the
data, e.g. for presentation or for an information system;
* subset >Attribute_C=: Attributes in this subset provide administrative information about the
...
Chapter 2.
$ Definition: Where possible each object class is defined and the source of the
definition is quoted.
$ References:
* INT 1: reference to the number of the paper chart feature in the >International
...
classes.
* M-4: reference to the paragraph number in the >Chart Specifications of the
IHO=, publication M-4. This was another guideline used in the definition
and description of object classes.
$ Remarks: Under >Remarks= further comments and notes are given. Related but
...
| M-4: not specified;   |     |     |     |
Remarks:
Distinction : land region; contiguous zone; continental shelf area; exclusive economic zone;
...
Set Attribute_A: DATEND; DATSTA; NOBJNM; OBJNAM; PEREND; PERSTA; QUASOU;
...
| --------------------- | ------ | --- | --- |
Set Attribute_A: CATACH; DATEND; DATSTA; NOBJNM; OBJNAM; PEREND; PERSTA;
RADIUS; STATUS;
...
| ------------------------ | ------ | --- | --- |
Set Attribute_A: BCNSHP; CATCAM; COLOUR; COLPAT; CONDTN; CONVIS; CONRAD;
...
Distinction: daymark; beacon lateral; beacon safe water; beacon isolated danger; beacon
...
Set Attribute_A: BCNSHP; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND;
...
Remarks:
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction: daymark; beacon lateral; beacon safe water; beacon cardinal; beacon special
purpose/general;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A: BCNSHP; CATLAM; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS;
DATEND; DATSTA; ELEVAT; HEIGHT; MARSYS; NATCON; NOBJNM;
OBJNAM; PEREND; PERSTA; STATUS; VERACC; VERDAT; VERLEN;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
...
Remarks:
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction: daymark; beacon cardinal; beacon safe water; beacon isolated danger; beacon
special purpose/general;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |
...
Remarks:
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction: daymark; beacon cardinal; beacon lateral; beacon isolated danger; beacon
special purpose/general;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
Set Attribute_A: BCNSHP; CATSPM; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS;
DATEND; DATSTA; ELEVAT; HEIGHT; MARSYS; NATCON; NOBJNM;
OBJNAM; PEREND; PERSTA; STATUS; VERACC; VERDAT; VERLEN;
Set Attribute_B: INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
...
| Berth                      | BERTHS | 10  |          |
Set Attribute_A: DATEND; DATSTA; DRVAL1; NOBJNM; OBJNAM; PEREND; PERSTA;
...
| M-4:    | 321.1; |     |     |
Remarks:
Distinction:  anchor berth; dock area; mooring/warping facility; shoreline construction;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
Set Attribute_A: CONDTN; DATEND; DATSTA; NATCON; NOBJNM; OBJNAM; STATUS;
WATLEV;
Set Attribute_B: INFORM; NINFOM; SCAMAX; SCAMIN;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
...
| Bridge                     | BRIDGE | 11  |          |
Set Attribute_A: CATBRG; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND;
...
M-4: 373.1-5;
Set Attribute_A: BUISHP; CATREB; COLOUR; CONDTN; CONRAD; CONVIS; HEIGHT;
...
Set Attribute_A: BUISHP; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; ELEVAT;
...
References:
INT 1: ID 5-6, 13; IE 10.1, 10.3, 11, 13-18, 28-30.1; IF 51, 60-63;
M-4:  325.1-3; 328.1; 362.2; 370.3,5; 372.1; 373.1-4; 375.1,2; 487.3;
Remarks:
...
| ------------------ | ------ | --- | --- |
Set Attribute_A: CATBUA; CONDTN; CONRAD; CONVIS; HEIGHT; NOBJNM; OBJNAM;
VERACC; VERDAT;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Set Attribute_A: BOYSHP; CATCAM; COLOUR; COLPAT; CONRAD; DATEND; DATSTA;
...
Remarks:
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction:  buoy  lateral;  buoy  safe  water;  buoy  isolated  danger;    buoy  special
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A: BOYSHP; CATINB; COLOUR; COLPAT; CONRAD; DATEND; DATSTA;
...
Set Attribute_A: BOYSHP; COLOUR; COLPAT; CONRAD; DATEND; DATSTA; MARSYS;
...
Remarks:
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction: buoy lateral; buoy safe water; buoy cardinal; buoy special purpose/general;
...
| ------------------ | ------ | --- | --- |
Set Attribute_A: BOYSHP; CATLAM; COLOUR; COLPAT; CONRAD; DATEND; DATSTA;
MARSYS; NATCON; NOBJNM; OBJNAM; PEREND; PERSTA; STATUS;
VERACC; VERLEN;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
...
Remarks:
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction: buoy  cardinal;  buoy  safe  water;  buoy  isolated  danger;  buoy  special
purpose/general; mooring/warping facility;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |
...
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction:  buoy cardinal; buoy lateral; buoy isolated danger; buoy special purpose/general;
mooring/warping facility;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
Set Attribute_A: BOYSHP; CATSPM; COLOUR; COLPAT; CONRAD; DATEND; DATSTA;
MARSYS; NATCON; NOBJNM; OBJNAM; PEREND; PERSTA; STATUS;
VERACC; VERLEN;
Set Attribute_B: INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
...
Remarks:
Topmark, light, fog signal, radar reflector and retro-reflector are separate objects.
Distinction: buoy lateral; buoy safe water; buoy isolated danger; buoy cardinal; buoy
...
Set Attribute_A: CATCBL; DATEND; DATSTA; NOBJNM; OBJNAM; RESTRN; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A: CATCBL; CONDTN; CONRAD; CONVIS; DATEND; DATSTA; ICEFAC;
...
Set Attribute_A: BURDEP; CATCBL; CONDTN; DATEND; DATSTA; DRVAL1; DRVAL2;
...
INT 1: IQ 100;
M-4: 456.2;
Set Attribute_A: COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND; DATSTA;
...
| Canal                      | CANALS | 23  |          |
Set Attribute_A: CATCAN; CONDTN; DATEND; DATSTA; HORACC; HORCLR; HORWID;
...
| M-4:     | 361.6; |     |     |
Remarks:
Distinction:  canal; coastline; lake shore; river bank; shoreline construction;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |
...
Set Attribute_A:      DATEND; DATSTA; NOBJNM; OBJNAM; PEREND; PERSTA; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      RECDAT; RECIND; SORDAT; SORIND; |     |     |     |
| ----------------------------------------------------- | --- | --- | --- |
Definition:
...
INT 1: IE 22;
M-4: 374.1;
Set Attribute_A: COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; HEIGHT; NATCON;
...
| Coastline                       | COALNE | 30                 |          |
Set Attribute_A: CATCOA; COLOUR; CONRAD; CONVIS; ELEVAT; NOBJNM; OBJNAM;
VERACC; VERDAT;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
| M-4:    | 440.6; |     |     |
Remarks:
Distinction: administrative area; continental area; exclusive economic zone; fishing zone;
...
| M-4:  440.8;   |     |     |     |
Remarks:
Distinction: administrative area; contiguous zone; exclusive economic zone; fishery zone;
territorial sea area;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
| ------------------ | ------ | --- | --- |
Set Attribute_A: CATCTR; DATEND; DATSTA; ELEVAT; NOBJNM; OBJNAM; VERACC;
VERDAT;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
| Conveyor                        | CONVYR | 34  |          |
Set Attribute_A: CATCON; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND;
...
| Crane         | CRANES | 35  |     |
| ------------- | ------ | --- | --- |
Set Attribute_A: CATCRN; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; HEIGHT;
...
Set Attribute_A: CURVEL; DATEND; DATSTA; NOBJNM; OBJNAM; ORIENT; PEREND;
PERSTA;
Set Attribute_B: INFORM; NINFOM; SCAMAX; SCAMIN;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
M-4: 408.2-3;
Remarks:
Distinction: tidal stream - harmonic prediction; tidal stream - non-harmonic prediction; tidal
...
| Dam                        | DAMCON | 38  |          |
Set Attribute_A:  CATDAM; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND;
...
| Daymark       | DAYMAR | 39  |     |
| ------------- | ------ | --- | --- |
Set Attribute_A:  CATSPM; COLOUR; COLPAT; DATEND; DATSTA; ELEVAT; HEIGHT;
...
| M-4:    | 456.2;  |     |     |
Remarks:
Distinction:  beacon, lateral; beacon, safe water; beacon, isolated danger; beacon, cardinal;
...
Set Attribute_A: CATTRK; DATEND; DATSTA; DRVAL1; DRVAL2; NOBJNM; OBJNAM;
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A: DATEND; DATSTA; DRVAL1; DRVAL2; NOBJNM; OBJNAM; ORIENT;
...
Distinction:  depth contour; dredged area; sounding; obstruction;  sea area/named water area;
...
INT 1: IL 43;
M-4: not specified
Set Attribute_A: CONDTN; DATEND; DATSTA; EXPSOU; PRODCT; QUASOU; SOUACC;
...
INT 1: IE 31;
M-4: 375.4;
Set Attribute_A: COLOUR; CONDTN; CONRAD; CONVIS; HEIGHT; NOBJNM; OBJNAM;
...
| Dock area          | DOCARE | 45  |     |
| ------------------ | ------ | --- | --- |
Set Attribute_A:      CATDOC; CONDTN; DATEND; DATSTA; HORACC; HORCLR; NOBJNM;
OBJNAM; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
| M-4:      | 326.3-4;  |     |     |
Remarks:
Distinction:  harbour area (administrative); cargo transhipment area; berth; harbour facility;
...
Set Attribute_A: DRVAL1; DRVAL2; NOBJNM; OBJNAM; QUASOU; RESTRN; SOUACC;
TECSOU; VERDAT;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
An area of the bottom of a body of water which has been deepened by dredging. (IHO Dictionary, S-
32, 5th Edition, 1462)
References:
| INT 1:  | II 20-23;       |     |     |
| ------- | --------------- | --- | --- |
...
| Dry dock           | DRYDOC | 47  |     |
| ------------------ | ------ | --- | --- |
Set Attribute_A:      CONDTN; DRVAL1; HORACC; HORCLR; HORLEN; HORWID; NOBJNM;
...
| ------------- | ------------------------------------------------------- | ------------- | --------------------------- |
| M-4:          | 326.1;                                                  |               |                             |
| Distinction:  | floating dock; gate; dock area; shoreline construction; |               |                             |
| Edition 3.1   |                                                         | November 2000 | S-57 Appendix A - Chapter 1 |
...
Acronym: DUNARE
Dune DUNARE
Set Attribute_A: COLOUR; CONRAD; CONVIS; HEIGHT; NATSUR; NATQUA; NOBJNM;
...
Set Attribute_A: CONDTN; CONRAD; DATEND; DATSTA; HEIGHT; NATCON; VERACC;
VERDAT; VERLEN;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
INT 1: IF 1;
M-4: 313.1;
Set Attribute_A: CATDYK; CONDTN; CONRAD; NATCON; NOBJNM; OBJNAM;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Geometric Primitive: Line;
Definition:
...
| M-4:  440.9;   |     |     |     |
Remarks:
Distinction:  administrative area; contiguous zone; continental shelf area; fishery zone;
territorial sea area;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |
...
| Fairway                    | FAIRWY | 51  |          |
Set Attribute_A: DATEND; DATSTA; DRVAL1; NOBJNM; OBJNAM; ORIENT; QUASOU;
...
| M-4:   | not specified; |     |     |
Remarks:
Distinction:  deep water route centerline; deep water route part; traffic separation scheme lane
part;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
| Fenceline        | FNCLNE | 52  |     |
| ---------------- | ------ | --- | --- |
Set Attribute_A: CATFNC; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; ELEVAT;
...
Set Attribute_A: CATFRY; DATEND; DATSTA; NOBJNM; OBJNAM; PEREND; PERSTA;
STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Acronym: FSHHAV
Fish haven FSHHAV
Set Attribute_A: EXPSOU; NOBJNM; OBJNAM; QUASOU; TECSOU; VALSOU; VERDAT;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
Distinction:  administrative area; contiguous zone; continental shelf area; exclusive economic
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A:      CATFIF; NOBJNM; OBJNAM; PEREND; PERSTA; STATUS; VERACC;
VERLEN;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
INT 1: IE 23; IL 11;
M-4: 374,1; 445,6;
Set Attribute_A: COLOUR; CONDTN; CONRAD; CONVIS; HEIGHT; NATCON; NOBJNM;
...
Set Attribute_A: CATFOG; DATEND; DATSTA; NOBJNM; OBJNAM; SIGFRQ; SIGGEN;
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A: CATFOR; CONDTN; CONRAD; CONVIS; HEIGHT; NATCON; NOBJNM;
...
| Gate          | GATCON | 61  |     |
| ------------- | ------ | --- | --- |
Set Attribute_A: CATGAT; CONDTN; DRVAL1; HORACC; HORCLR; NATCON; NOBJNM;
...
| Gridiron                        | GRIDRN | 62  |          |
Set Attribute_A:  HORACC; HORLEN; HORWID; NATCON; NOBJNM; OBJNAM; STATUS;
...
Set Attribute_A:      CATHAF; CONDTN; DATEND; DATSTA; NATCON; NOBJNM; OBJNAM;
...
INT 1: IC 4;
M-4: 312.1;
Set Attribute_A: CONRAD; CONVIS; HEIGHT; NATQUA; NATSUR; NOBJNM; OBJNAM;
QUAVEM; VERDAT;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Geometric Primitive: Area;
...
| Hulk                       | HULKES | 65  |          |
Set Attribute_A:      CATHLK; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; HORACC;
...
| Ice area           | ICEARE | 66  |     |
| ------------------ | ------ | --- | --- |
Set Attribute_A: CATICE; CONVIS; ELEVAT; HEIGHT; NOBJNM; OBJNAM; PEREND;
...
Set Attribute_A:      NOBJNM; OBJNAM; PEREND; PERSTA; RESTRN; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
M-4: 435.1;
Remarks:
Distinction: traffic separation scheme crossing; traffic separation scheme lane part; traffic
...
| M-4:    | 353, 353.6; |     |     |
Remarks:
Distinction:  canal bank; coastline; lake area; river bank; shoreline construction;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
| M-4:    | 421.1; |     |     |
Remarks:
Distinction:  canal; coastline; depth area; lake; land region; river; sea bed area; shoreline
...
Set Attribute_A:      CONVIS; ELEVAT; NOBJNM; OBJNAM; VERACC; VERDAT;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
| ------------------ | ------ | --- | --- |
Set Attribute_A:      CATLND; NATQUA; NATSUR; NOBJNM; OBJNAM; WATLEV;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
A landing is a place where boats receive or discharge passengers, freight, etc.. (IHO Dictionary, S-
32, 4th Edition)
References:
INT 1: IF 17;
M-4: 324.2;
...
| Landmark                        | LNDMRK | 74  |          |
Set Attribute_A: CATLMK; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; ELEVAT;
FUNCTN; HEIGHT; NATCON; NOBJNM; OBJNAM; STATUS; VERACC;
VERDAT; VERLEN;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
...
References:
INT 1: ID 5-6, 13; IE 10.1-20, 22-30.1, 30.3-4, 31; IL 11; IQ 100;
M-4: 373.6; 374.1; 374.4; 374.5; 374.6; 374.7; 375.1-2; 375.4; 445.6; 456.2; 487.3;
Remarks:
Distinction:  beacon, special purpose/general; building single; daymark; pylon/bridge support;
topmark;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |
...
| Light         | LIGHTS | 75  |     |
| ------------- | ------ | --- | --- |
Set Attribute_A: CATLIT; COLOUR; DATEND; DATSTA; EXCLIT; HEIGHT; LITCHR; LITVIS;
...
Distinction:  beacon, cardinal; beacon, isolated danger; beacon, lateral; beacon, safe water;
...
Set Attribute_A: COLOUR; COLPAT; CONRAD; CONVIS; DATEND; DATSTA; HORACC;
...
Distinction: buoy, cardinal; buoy, installation; buoy, isolated danger; buoy, lateral; buoy, safe
...
INT 1: IP 31;
M-4: 475.8;
Set Attribute_A: COLOUR; DATEND; DATSTA; HEIGHT; NOBJNM; OBJNAM; ORIENT;
PEREND; PERSTA; QUAVEM; STATUS; VALNMR; VERDAT;
Set Attribute_B: INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Geometric Primitive: Point;
Definition:
The moiré effect is the effect created by transmitting light through two separate, overlapping families
of parallel lines. (IHO Dictionary, S-32, 4th Edition)
Remarks:
The attribute >orientation= indicates the orientation of the leading line of the moiré effect light
measured from the water towards the light.
Distinction: light;
This object is obsolete. It is only shown here for reasons of backward compatibility. A moiré effect
...
Set Attribute_A: DATEND; DATSTA; HORACC; HORCLR; HORLEN; HORWID; NOBJNM;
OBJNAM; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A: CATMFA; DATEND; DATSTA; EXPSOU; NOBJNM; OBJNAM; PEREND;
...
INT 1: IE 28, 30.1;
M-4: 375.1-2;
Set Attribute_A: CATMST; COLOUR; COLPAT; CONRAD; CONVIS; HEIGHT; NOBJNM;
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A:      CATMPA; DATEND; DATSTA; NOBJNM; OBJNAM; PEREND; PERSTA;
RESTRN; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      RECDAT; RECIND; SORDAT; SORIND; |     |     |     |
| ----------------------------------------------------- | --- | --- | --- |
...
| M-4:  441.1-6;    |     |     |     |
Remarks:
| Distinction:  caution area; restricted area; submarine transit lane; |     |               |                             |
| -------------------------------------------------------------------- | --- | ------------- | --------------------------- |
| Edition 3.1                                                          |     | November 2000 | S-57 Appendix A - Chapter 1 |

Object Classes 1.107
GEO OBJECT CLASSES
...
INT 1: IE 24;
M-4: 374.4;
Set Attribute_A: BUISHP; CATMNT; COLOUR; CONDTN; CONRAD; CONVIS; HEIGHT;
NATCON; NOBJNM; OBJNAM; QUAVEM; VERDAT; VERLEN;
Set Attribute_B: INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Geometric Primitive: Point;
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A: BOYSHP; CATMOR; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS;
...
et Océanographique de la Marine, France)
References:
| INT 1:  | IM 1-3;    |     |     |
| ------- | ---------- | --- | --- |
| M-4:    | 433-433.5; |     |     |
...
Set Attribute_A: CATOBS; CONDTN; EXPSOU; HEIGHT; NATCON; NATQUA; NATSUR;
...
Remarks:
Distinction:  wreck; fishing facility; marine farm/culture; depth area; underwater/awash rock;
water turbulence;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |

| 1.112 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
GEO OBJECT CLASSES
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A: CATOFP; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND;
...
Set Attribute_A: CATPRA; CONDTN; CONRAD; CONVIS; DATEND; DATSTA; HEIGHT;
...
| ------------------ | ------ | --- | --- |
Set Attribute_A:      CATOLB; CONDTN; DATEND; DATSTA; NOBJNM; OBJNAM; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
Object Classes 1.115
GEO OBJECT CLASSES
Object Class: Pile
Acronym: PILPNT Code: 90
Pile PILPNT90
Set Attribute_A: CATPLE; COLOUR; COLPAT; CONDTN; CONVIS; DATEND; DATSTA;
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A: CATPIL; COMCHA; DATEND; DATSTA; NOBJNM; NPLDST; OBJNAM;
...
INT 1: not specified
M-4: not specified
Set Attribute_A: CONRAD; CONVIS; EXPSOU; HEIGHT; NATQUA; NATSUR; NOBJNM;
...
| ------------------ | ------ | --- | --- |
Set Attribute_A:      CATPIP; CONDTN; DATEND; DATSTA; NOBJNM; OBJNAM; PRODCT;
RESTRN; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Set Attribute_A: CATPIP; CONDTN; CONRAD; CONVIS; DATEND; DATSTA; NOBJNM;
...
| --------------------------------- | ------ | --- | --- |
Set Attribute_A: BURDEP; CATPIP; CONDTN; DATEND; DATSTA; DRVAL1; DRVAL2;
...
| Pontoon                    | PONTON | 95  |          |
Set Attribute_A: CONDTN; CONRAD; CONVIS; DATEND; DATSTA; NATCON; NOBJNM;
...
| M-4:    | 326.9; |     |     |
Remarks:
Distinction:  bridge; mooring/warping facility; shoreline construction;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |

| 1.122 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
GEO OBJECT CLASSES
...
| M-4:    | 435.2;     |     |     |
Remarks:
Distinction:  caution area; inshore traffic zone; restricted area; all traffic separation scheme
elements;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |

Object Classes 1.123
GEO OBJECT CLASSES
...
Set Attribute_A: CATPRI; CONDTN; CONRAD; CONVIS; DATEND; DATSTA; EXPSOU;
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A: CATPRA; CONDTN; CONRAD; CONVIS; DATEND; DATSTA; ELEVAT;
...
Set Attribute_A: CATPYL; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND;
DATSTA; HEIGHT; NATCON; NOBJNM; OBJNAM; VERACC; VERDAT;
VERLEN; WATLEV;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      RECDAT; RECIND; SORDAT; SORIND; |     |     |     |
...
| ------------------ | ------ | --- | --- |
Set Attribute_A:      COMCHA; DATEND; DATSTA; NOBJNM; OBJNAM; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
| ------------------ | ------ | --- | --- |
Set Attribute_A: CATRAS; COMCHA; DATEND; DATSTA; HEIGHT; NOBJNM; OBJNAM;
...
Set Attribute_A: CATRTB; DATEND; DATSTA; NOBJNM; OBJNAM; RADWAL; SECTR1;
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A: COMCHA; DATEND; DATSTA; NOBJNM; OBJNAM; ORIENT; PEREND;
...
Set Attribute_A: CALSGN; CATROS; COMCHA; DATEND; DATSTA; ESTRNG; NOBJNM;
...
| Railway       | RAILWY | 106 |     |
| ------------- | ------ | --- | --- |
Set Attribute_A:      CONDTN; HEIGHT; NOBJNM; OBJNAM; STATUS; VERACC;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
INT 1: IF 23;
M-4: not specified
Set Attribute_A: CONDTN; HORCLR; HORLEN; HORWID; NATCON; NOBJNM; OBJNAM;
STATUS; WATLEV;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
...
| M-4:    | 353.5; |     |     |
Remarks:
Distinction:  current - non-gravitational; tidal stream - harmonic prediction; tidal stream - non-
harmonic prediction; tidal stream panel data; tidal stream - time series; water
turbulence; waterfall;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |

|     | Object Classes     |     | 1.137 |
| --- | ------------------ | --- | ----- |
|     | GEO OBJECT CLASSES |     |       |
...
| ----------------------- | ------ | --- | --- |
Set Attribute_A:      CATRSC; DATEND; DATSTA; NOBJNM; OBJNAM; PEREND; PERSTA;
STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Set Attribute_A: CATREA; DATEND; DATSTA; NOBJNM; OBJNAM; PEREND; PERSTA;
RESTRN; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Remarks:
Distinction:  anchorage area; cable area; caution area; dumping ground; depth area; fairway;
dredged area; deep water route; military practice area; pipeline area; swept area;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |

| 1.142 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
GEO OBJECT CLASSES
...
| ------------------------ | ------ | --- | --- |
Set Attribute_A: COLOUR; COLPAT; HEIGHT; MARSYS; STATUS; VERACC; VERDAT;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
Distinction:  canal; lake; river bank; sea area/named water area; tideway;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |

| 1.144 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
GEO OBJECT CLASSES
...
| M-4:    | 353.1-4;   |     |     |
Remarks:
Distinction:  canal bank; coastline; lake shore; river; shoreline construction;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |

Object Classes 1.145
GEO OBJECT CLASSES
Object Class: Road
Acronym: ROADWY Code: 116
Road ROADWY
Set Attribute_A: CATROD; CONDTN; NATCON; NOBJNM; OBJNAM; STATUS;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
| Runway        | RUNWAY | 117 |     |
| ------------- | ------ | --- | --- |
Set Attribute_A:      CATRUN; CONDTN; CONVIS; NATCON; NOBJNM; OBJNAM; PEREND;
PERSTA; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Set Attribute_A:      COLOUR; NATQUA; NATSUR; NOBJNM; OBJNAM; WATLEV;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
Definition:
...
Also called character (or characteristics) of the bottom, or quality of the bottom. (IHO Dictionary, S-
32, 5th Edition, 515).
References:
| INT 1:  | IJ 1-11, 30-39;    |     |     |
| ------- | ------------------ | --- | --- |
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A: CATSLC; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; DATEND;
...
Remarks:
Distinction:  canal bank; coastline; lake shore; land area; pontoon; river bank;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |

Object Classes 1.155
GEO OBJECT CLASSES
Object Class: Signal station, traffic
Acronym: SISTAT Code: 123
Signal station, traffic SISTAT123
Set Attribute_A: CATSIT; COMCHA; DATEND; DATSTA; NOBJNM; OBJNAM; PEREND;
PERSTA; STATUS;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
A signal station is a place on shore from which signals are made to ships at sea. (IHO Dictionary, S-
32, 5th Edition, 4742)
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A:      CATSIW; COMCHA; DATEND; DATSTA; NOBJNM; OBJNAM; PEREND;
PERSTA; STATUS;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      RECDAT; RECIND; SORDAT; SORIND; |     |     |     |
| ----------------------------------------------------- | --- | --- | --- |
...
Set Attribute_A: BUISHP; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; HEIGHT;
...
1.158 Object Classes
GEO OBJECT CLASSES
Object Class: Silo/tank
Acronym: SILTNK Code: 125
Silo/tank SILTNK125
Set Attribute_A: BUISHP; CATSIL; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS;
...
| ------------------ | ------ | --- | --- |
Set Attribute_A: CATSLO; COLOUR; CONRAD; CONVIS; ELEVAT; NATCON; NATQUA;
...
Set Attribute_A:      CATSLO; COLOUR; CONRAD; CONVIS; NATCON; NATQUA; NATSUR;
NOBJNM; OBJNAM;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
| Sounding                        | SOUNDG | 129 |           |
Set Attribute_A:      EXPSOU; NOBJNM; OBJNAM; QUASOU; SOUACC; STATUS; TECSOU;
VERDAT;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
| M-4:    | not specified; |     |     |
Remarks:
| Distinction:  | road; built-up area; building, single; |               |                             |
| ------------- | -------------------------------------- | ------------- | --------------------------- |
| Edition 3.1   |                                        | November 2000 | S-57 Appendix A - Chapter 1 |

|     | Object Classes |     | 1.167 |
| --- | -------------- | --- | ----- |
GEO OBJECT CLASSES
...
INT 1: ID 25;
M-4: 382.3;
Set Attribute_A: CONDTN; CONRAD; CONVIS; DATEND; DATSTA; LIFCAP; NOBJNM;
...
Distinction: current - non-gravitational; tidal stream - non-harmonic prediction; tidal stream
panel data; tidal stream - time series;
Edition 3.1 November 2000 S-57 Appendix A - Chapter 1

Object Classes 1.175
GEO OBJECT CLASSES
...
Distinction: current - non-gravitational; tidal stream - harmonic prediction; tidal stream panel
data; tidal stream - time series;
S-57 Appendix A - Chapter 1 November 2000 Edition 3.1

| 1.176 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
GEO OBJECT CLASSES
...
Distinction: current - non-gravitational; tidal stream - harmonic prediction; tidal stream - non-
harmonic prediction; tidal stream - time series;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |

Object Classes 1.177
GEO OBJECT CLASSES
Object Class: Tidal stream - time series
Acronym: TS_TIS Code: 139
Tidal stream - time series TS_TIS139
Set Attribute_A: NOBJNM; OBJNAM; TIMEND; TIMSTA; T_TINT; TS_TSV; STATUS;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
A tidal stream (or tidal current) is an alternating horizontal movement of water associated with the
...
Distinction: current - non-gravitational;tidal stream - harmonic prediction; tidal stream - non-
harmonic prediction; tidal stream panel data;
S-57 Appendix A - Chapter 1 November 2000 Edition 3.1

| 1.178 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
GEO OBJECT CLASSES
...
1.180 Object Classes
GEO OBJECT CLASSES
Object Class: Tide - time series
Acronym: T_TIMS Code: 142
Tide - time series T_TIMS142
Set Attribute_A: NOBJNM; OBJNAM; T_ACWL; T_HWLW; T_TINT; T_TSVL; TIMEND;
TIMSTA; STATUS;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
| Topmark           | TOPMAR | 144 |     |
| ----------------- | ------ | --- | --- |
Set Attribute_A: COLOUR; COLPAT; HEIGHT; MARSYS; STATUS; TOPSHP; VERACC;
VERDAT; VERLEN;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Object Classes 1.183
GEO OBJECT CLASSES
Object Class: Tower
DELETED - DO NOT USE
Acronym: TOWERS
Tower TOWERS
Set Attribute_A: CATTOW; COLOUR; COLPAT; CONDTN; CONRAD; CONVIS; HEIGHT;
...
| M-4:  435.1;   |     |     |     |
Remarks:
Distinction:  traffic separation scheme boundary; traffic separation scheme crossing; traffic
separation scheme lane part; traffic separation scheme roundabout; traffic
separation zone;
| Edition 3.1 |     | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | --- | ------------- | --------------------------- |

Object Classes 1.185
GEO OBJECT CLASSES
...
M-4: 436;
Remarks:
Distinction: traffic separation line; traffic separation scheme crossing; traffic separation
scheme lane part; traffic separation scheme roundabout; traffic separation zone;
S-57 Appendix A - Chapter 1 November 2000 Edition 3.1

1.186 Object Classes
GEO OBJECT CLASSES
...
M-4: 435.1;
Remarks:
Distinction: traffic separation line; traffic separation scheme boundary; traffic separation
scheme lane part; traffic separation scheme roundabout; traffic separation zone;
Edition 3.1 November 2000 S-57 Appendix A - Chapter 1

Object Classes 1.187
GEO OBJECT CLASSES
Object Class: Traffic separation scheme lane part
Acronym: TSSLPT Code: 148
Traffic separation scheme lane part TSSLPT 148
Set Attribute_A: CATTSS; DATEND; DATSTA; ORIENT; RESTRN; STATUS;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
A traffic separation scheme is a scheme which aims to reduce the risk of collision in congested
...
Distinction: recommended traffic lane part; traffic separation line; traffic separation scheme
boundary; traffic separation scheme crossing; traffic separation scheme
roundabout; traffic separation zone;
S-57 Appendix A - Chapter 1 November 2000 Edition 3.1

1.188 Object Classes
GEO OBJECT CLASSES
...
INT 1: IC 31-31.8;
M-4: 354.2;
Set Attribute_A: CATTRE; CONVIS; HEIGHT; NOBJNM; OBJNAM; QUAVEM; VERDAT;
VERLEN;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Geometric Primitive: Point;
...
| Tunnel                     | TUNNEL | 151 |           |
Set Attribute_A:      BURDEP; CONDTN; HORACC; HORCLR; NOBJNM; OBJNAM; STATUS;
VERACC; VERCLR;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Set Attribute_A: CATTRK; DATEND; DATSTA; DRVAL1; DRVAL2; ORIENT; QUASOU;
...
Distinction: deep water route part; recommended traffic lane part; traffic separation scheme
lane part;
| S-57 Appendix A - Chapter 1 |     | November 2000 | Edition 3.1 |
| --------------------------- | --- | ------------- | ----------- |

| 1.194 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
GEO OBJECT CLASSES
...
| ---------------------------- | ------ | --- | --- |
Set Attribute_A: EXPSOU; NATQUA; NATSUR; NOBJNM; OBJNAM; QUASOU; SOUACC;
...
| ------------------ | ------ | --- | --- |
Set Attribute_A:      CATVEG; CONVIS; ELEVAT; HEIGHT, NOBJNM; OBJNAM; VERACC;
VERDAT; VERLEN;
Set Attribute_B:      INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
| Set Attribute_C:      | RECDAT; RECIND; SORDAT; SORIND; |     |     |
| --------------------- | ------------------------------- | --- | --- |
...
Object Classes 1.197
GEO OBJECT CLASSES
DELETED - DO NOT USE
Object Class: Vegetation area
Acronym: VEGARE
Vegetation area VEGARE
Set Attribute_A: CATVEG; CONVIS; HEIGHT, NOBJNM; OBJNAM; VERACC; VERDAT;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
Object Classes 1.201
GEO OBJECT CLASSES
Object Class: Weir
DELETED - DO NOT USE
Acronym: WIRLNE
Weir WIRLNE
Set Attribute_A: CONDTN; DATEND; DATSTA; NATCON; NOBJNM; OBJNAM; QUAVEM;
VERLEN;
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMAX; SCAMIN; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
| Wreck         | WRECKS | 159 |     |
| ------------- | ------ | --- | --- |
Set Attribute_A: CATWRK; CONRAD; CONVIS; EXPSOU; HEIGHT; NOBJNM; OBJNAM;
...
Object Classes 1.205
GEO OBJECT CLASSES
Object Class: Zero metre - contour
DELETED - DO NOT USE
Acronym: ZEMCNT
Zero metre - contour ZEMCNT
INT 1: II 30;
M-4: 404.2; 410-411;
...
| 1.206 | Object Classes |     |
| ----- | -------------- | --- |
Page intentionally left blank
| Edition 3.1 | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | ------------- | --------------------------- |

|     | Object Classes | 1.207 |
| --- | -------------- | ----- |
1.3 Meta Object Classes
| S-57 Appendix A - Chapter 1 | November 2000 | Edition 3.1 |
| --------------------------- | ------------- | ----------- |

| 1.208 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
META OBJECT CLASSES
...
Set Attribute_A:
Set Attribute_B:      INFORM; NINFOM; NTXTDS; PICREP; PUBREF; TXTDSC;
Set Attribute_C:      RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
Set Attribute_B: INFORM; NINFOM; NTXTDS; SCAMIN; SCAMAX; TXTDSC;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
| --------------- | ------ | --- | --- |
Set Attribute_A: CATQUA; CATZOC; DRVAL1; DRVAL2; POSACC; SOUACC; SUREND;
...
| ------------------------ | ------ | --- | --- |
Set Attribute_A: QUAPOS; QUASOU; SCVAL1; SCVAL2; SDISMN; SDISMX; SURATH;
...
Object Classes 1.219
META OBJECT CLASSES
Object Class: Survey source
DELETED - DO NOT USE
Acronym: M_SSOR
Survey source M_SSOR
Set Attribute_A: DATEND; DATSTA; SCVAL1; SCVAL2; SURATH; SUREND; SURSTA;
SURTYP; TECSOU;
Set Attribute_B: INFORM; NINFOM;
Set Attribute_C: RECDAT; RECIND; SORDAT; SORIND;
Definition:
...
| 1.222 | Object Classes |     |
| ----- | -------------- | --- |
Page intentionally left blank
| Edition 3.1 | November 2000 | S-57 Appendix A - Chapter 1 |
| ----------- | ------------- | --------------------------- |

|     | Object Classes | 1.223 |
| --- | -------------- | ----- |
1.4 Collection Object Classes
| S-57 Appendix A - Chapter 1 | November 2000 | Edition 3.1 |
| --------------------------- | ------------- | ----------- |

| 1.224 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
...
Remarks:
An aggregation could be used to combine objects that are related in some way (is-a-part-of, is-a-
component-of) into a higher level object.
...
|     | Object Classes | 1.227 |
| --- | -------------- | ----- |
1.5 Cartographic Object Classes
| S-57 Appendix A - Chapter 1 | November 2000 | Edition 3.1 |
| --------------------------- | ------------- | ----------- |

| 1.228 |     | Object Classes |     |
| ----- | --- | -------------- | --- |
